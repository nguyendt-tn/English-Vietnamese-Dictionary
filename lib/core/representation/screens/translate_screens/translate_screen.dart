...
import 'package:dictionary/core/representation/widgets/button_widget.dart';
                                  ...
                                  child: Container(
                                    ...
                                    child: DropdownButtonHideUnderline(
                                      child: DropdownButton2(
                                        ...
                                        buttonWidth: screnSize.width * 0.4,
                                      ),
                                    ),
                                  )),
                              SizedBox(
                                width: screnSize.width * 0.1 - 12,
                              ),
                              Expanded(
                                  flex: 1,
                                  child: Container(
                          ...
                          ButtonWidget(
                              ...
                              ontap: () async {
                                ...
                                if (result == ConnectivityResult.none) {
                                  return EasyLoading.showToast(
                                      translation(context).errorConnection);
                                }
                                EasyLoading.show();
